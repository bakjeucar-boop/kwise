...
_OVERVIEW: dict[str, str] = {
    ...
    # **제도 수치는 매뉴얼 4.4 가 쥔다** (S207 2절). 앞서는 여기서 92% 기준·매 1%당
    # 0.2%·감액 상한 97%·미달 추가요금을 다 적었는데, 그 넷은 같은 카드의 계산 근거
    # 표(「기준 92% 대비 매 1%당 기본요금의 0.2% (60~97% 밖은 간주)」)와 카드 캡션
    # 툴팁이 19벌 모두에 이미 세우고 매뉴얼 4.4 표가 상한·하한까지 적는다.
    # 앞머리 「역률을 높이면 기본요금이 감액됩니다」 는 역률 100 세 벌에서 거짓이다.
    "power_factor": "기본요금은 지상역률로 조정됩니다.",
    "solar": (
