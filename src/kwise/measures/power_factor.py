...
def evaluate_power_factor(
    ...
    *,
    ...
    warnings.append(
        f"콘덴서를 키우면 야간에 진상으로 넘어갈 수 있습니다. 야간(22~08시) 진상역률 "
        f"기준은 {LEADING_STANDARD_PCT:.0f}% 이며 미달 시 매 1%당 기본요금의 0.2% 가 "
        "추가됩니다 (제43조 ②). 자동 역률조정장치(APFR)로 시간대별 투입을 "
        "제어하십시오."
    )
    warnings.append(
