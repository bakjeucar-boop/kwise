...
#: **S214 에 절감액 칸을 0.115 → 0.135 로 넓혔다.** 그 칸 이름이 「연간 절감액」
#: 에서 「12개월 환산 절감액」 으로 가면서 1.298in 에 **두 줄로 흘렀다** —
#: 0.135(1.545in)에서 한 줄에 앉는다. 늘린 몫은 목표(0.150 → 0.140)와
#: 표식(0.200 → 0.190)에서 0.010 씩 가져왔고 **합은 1.0 그대로**다.
