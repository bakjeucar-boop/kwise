...
KNOWN_LIMITS: tuple[str, ...] = (
    ...
    "피크 절감량이 보수적으로 나옵니다.",
    "역률요금은 추정 역률 기반 산출입니다. 무효전력 실측이 없습니다 — 기본공급약관 "
    "제42조는 30분 누적 계량을 요구하는데 본 데이터는 15분 유효전력뿐입니다. "
    "기본값 92%는 같은 조항이 무효전력계 미설치 고객에게 적용하는 간주값이며, "
    "이 값에서는 추가·감액이 0원입니다. 청구서의 역률을 넣으면 재계산됩니다.",
    "역률 추가요금은 약관 제43조 ③에 따라 첫 달이 예고, 두 번째 달부터 청구입니다. "
    ...
    "제시합니다.",
    "경제성DR의 CBL(고객기준부하)은 전력거래소가 별표28 방식으로 산정합니다 "
    "(전력시장운영규칙 제12.5.2.1조). 본 도구의 감축 가능량은 실측 부하 기준의 "
    "추정이며 실제 정산 기준량과 다릅니다.",
    "**대한민국 전용 도구입니다.** 요금 체계(한전 기본공급약관·전기요금표), 역률 규정"
    "(제41~43조), 경제성DR(전력시장운영규칙 제12장), 공휴일, 시군구 좌표 229개가 모두 "
    "한국 제도에 묶여 있습니다. 해외 부지에는 적용할 수 없습니다 (요구사항서 1.4).",
